...
export const metadata: Metadata = {
  title: "Conditions Générales de Vente (CGV) | STRONG4K",
  description: "Conditions générales de vente et d'utilisation du service STRONG4K.",
  alternates: {
    ...
    <div className="pt-28 pb-16 space-y-12 bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6">
        ...
        <div className="py-6 space-y-4">
          <h1 className="text-3xl sm:text-5xl font-black text-slate-900">Conditions Générales de Vente</h1>
        ...
        <div className="bg-slate-50 p-8 rounded-3xl border border-slate-200 shadow-sm space-y-6 text-sm text-slate-700 font-medium leading-relaxed">
          <section className="space-y-2">
            <h2 className="text-lg font-bold text-slate-900">1. Objet & Champ d'application</h2>
            <p>
          ...
          <section className="space-y-2">
            <h2 className="text-lg font-bold text-slate-900">2. Formules d'Abonnement & Tarifs</h2>
            <p>
          ...
          <section className="space-y-2">
            <h2 className="text-lg font-bold text-slate-900">3. Activation & Livraison</h2>
            <p>
          ...
          <section className="space-y-2">
            <h2 className="text-lg font-bold text-slate-900">4. Engagement & Résiliation</h2>
            <p>

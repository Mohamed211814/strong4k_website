...
export const metadata: Metadata = {
  title: "Politique de Remboursement | STREAMORA",
  description: "Conditions d'annulation et règles de remboursement du service STREAMORA.",
  alternates: {
    ...
    <div className="pt-28 pb-16 space-y-12">
      <div className="max-w-4xl mx-auto px-4 sm:px-6">
        ...
        <div className="py-6 space-y-4">
          <h1 className="text-3xl sm:text-5xl font-extrabold text-white">Politique de Remboursement</h1>
        ...
        <div className="glass-card p-8 rounded-3xl border border-white/10 space-y-6 text-sm text-gray-300 leading-relaxed">
          <section className="space-y-2">
            <h2 className="text-lg font-bold text-white">1. Principe de Prise en Charge</h2>
            <p>
          ...
          <section className="space-y-2">
            <h2 className="text-lg font-bold text-white">2. Modalités de Demande</h2>
            <p>
              Toute demande doit être adressée à notre support client à l'adresse e-mail <span className="font-mono text-purple-300">{siteConfig.supportEmail}</span> avec votre numéro de commande (ex: STR-XXXXXX) et la description du problème rencontré.
            </p>
          </section>
        </div>
      </div>
